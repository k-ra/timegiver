...
def search():
    if request.method == "POST":
        ...
        # I know this isn't the best way to replace org_id with the name but please forgive me. I'll fix it later
        ...
        return render_template("results.html", table=table, orgs = orgs)
